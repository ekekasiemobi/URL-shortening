  ...
  return (
    <>
        <footer className='pt-15 pb-15 bg-[#242028]'>
            <div className='text-white flex flex-col md:flex-row w-full max-w-[80vw] mx-auto justify-center items-center text-center md:justify-between md:items-start md:text-left gap-8'>
